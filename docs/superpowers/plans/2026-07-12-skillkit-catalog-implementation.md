...
- [ ] **Step 1: 创建 module 声明与最小 package 注释**
...
- [ ] **Step 2: 将 module 纳入 workspace 与验证链**
...
- [ ] **Step 1: 写失败测试，表达可移植 manifest 的最小输入**
...
- [ ] **Step 1: 写失败测试，固定 discovery 的安全输出**
...
- [ ] **Step 1: 写失败测试，表达 fail-closed 准入矩阵**
