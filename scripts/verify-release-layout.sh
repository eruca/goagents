...
published_modules=(
  "goagent|${MODULE_PREFIX}goagent|v0.1.1|goagent/v0.1.1|release-delta"
  ...
  "llmkit|${MODULE_PREFIX}llmkit|v0.1.1|llmkit/v0.1.1|release-delta"
...
internal_requirements=(
  "llmkit|${MODULE_PREFIX}goagent|v0.1.1"
